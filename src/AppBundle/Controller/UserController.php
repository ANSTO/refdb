...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pending = $em->getRepository('AppBundle:User')->findBy(["enabled"=>true]);

        $pending = array_filter($pending, function($user) {
        ...
        /** @var User $user */
        $admins = array_filter($users, function($user) use ($current) {
